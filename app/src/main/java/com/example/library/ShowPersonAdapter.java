...
public class ShowPersonAdapter extends ArrayAdapter<Designation> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView personDepartment = convertView.findViewById(R.id.showStudentClass_Grade);
        ...
        personDepartment.setText(people.get(position).getmClass());
        personDesignation.setText("Student Id:");
