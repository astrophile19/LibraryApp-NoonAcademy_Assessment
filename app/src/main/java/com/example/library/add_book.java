...
public class add_book extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText Bclass =findViewById(R.id.Addclass_grade);
        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bclass =Bclass.getText().toString().trim();
                ...
                if(TextUtils.isEmpty(bclass)){
                    iserror = true;
                    BID.setError("Enter Class/Grade");
                }
                ...
                if(!iserror){
                    ...
                    isInserted = db.insertIntoBook(btitle,bclass,author,bid,price,edition,genre,publisher,year);
