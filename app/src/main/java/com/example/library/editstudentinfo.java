...
public class editstudentinfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText SClass = findViewById(R.id.editstudentclass);
        ...
        submitbtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(sclass.isEmpty())
                {
                    SClass.setError("Enter department");
                    iserror = true;
                }
                if(sid.isEmpty())
                {
                ...
                if(!iserror)
                {
                    ...
                    boolean isUpdated;
                    if(mname.isEmpty()) {
                        isUpdated = db.updateStudent(sid,fname + " " + lname, email, phone, sclass);
                    }
                    else
                    {
                        isUpdated = db.updateStudent(sid,fname + " " + mname + " " + lname, email, phone, sclass);
                    }
                    if(isUpdated)
                    {
